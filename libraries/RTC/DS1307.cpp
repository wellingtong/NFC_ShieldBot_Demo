...
//   modify:
//   loovee 2013-9-4
//   add etTime(int hourMode); when set time, suppose set 12-hour or 24-hour
//
...
void DS1307::setTime(int hourMode)
{
